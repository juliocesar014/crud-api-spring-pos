...
import com.example.api2.model.dto.ErrorDTO;
...
public class HandlerException {
    ...
    public ResponseEntity<ErrorDTO> handlerException(Exception e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorCapture);
    }
    ...
    public ResponseEntity<ErrorDTO> handlerException(NoSuchElementException e) {
        ...
        log.info("Erros", e.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorCapture);
    }
